...
def legend(legend, size=None):
    ...
    if size:
        ...
        templates = {
            'small': 'legends/widgets/small.html',
            'medium': 'legends/widgets/medium.html',
            'large': 'legends/widgets/large.html',
        }
...
@register.simple_tag
def npc(name):
    template = 'legends/widgets/large.html'
    context = {
        'name': name,
