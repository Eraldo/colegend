# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-06-13 22:30
...
def create_focus_from_entries(apps, schema_editor):
    ...
    for entry in MonthEntry.objects.all():
        if entry.outcome_1 or entry.outcome_2 or entry.outcome_3 or entry.outcome_4:
            ...
            # otherwise I get an error `AttributeError: 'MonthEntry' object has no attribute 'date'`.
            date = timezone.datetime.strptime('{}-M{}'.format(entry.year, entry.month), "%Y-M%m").date()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('monthentries', '0003_auto_20170213_1641'),
