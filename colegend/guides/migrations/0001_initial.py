    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner',
                 annoying.fields.AutoOneToOneField(serialize=False, primary_key=True, to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ...
                ('guide', models.ForeignKey(null=True, related_name='guidee_relations', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
                'abstract': False,
            },
